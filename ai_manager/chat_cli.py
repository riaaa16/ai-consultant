...
def _build_prompt(user_instruction: str) -> str:
    return (
        ...
        "}\n\n"
        "Operation notes:\n"
        "- Prefer operation=append for small edits. Use replace ONLY if the user explicitly asks to rewrite/replace the entire site.json.\n"
        ...
        "    - IMPORTANT: city/country are NOT valid fields. Use bio.location as a single string like \"Jersey City, USA\".\n"
        ...
        "  - contact append: data is partial merge of ONLY these string fields: email, linkedin, github, filloutEmbedUrl, filloutEmbedCode\n"
        "  - contact delete: data keys are cleared to empty strings\n\n"
        "Examples:\n"
        "- Change location: {\"file\":\"site.json\",\"operation\":\"append\",\"content\":{\"section\":\"bio\",\"data\":{\"location\":\"Jersey City, USA\"}}}\n\n"
